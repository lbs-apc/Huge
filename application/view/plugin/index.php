<div class="container">
    ...
    if (!empty($this->plugins)) {
        foreach ($this->plugins as $plugin) {
            if ((int)$plugin->user_installed > 0) {
                $installed[] = $plugin;
            } else {
                $available[] = $plugin;
            }
    ...
    <div class="box" style="margin-bottom: 30px;">
        ...
        <table style="width:100%; border-collapse: collapse;">
            ...
            <tbody>
                <?php if (!empty($installed)) { foreach ($installed as $plugin) { ?>
                    <tr>
                ...
                <?php } } else { ?>
                    <tr><td colspan="4" style="padding:8px;">No installed plugins found.</td></tr>
                <?php } ?>
            </tbody>
        </table>
    </div>
    ...
    <div class="box">
        ...
        <table style="width:100%; border-collapse: collapse;">
            ...
            <tbody>
                <?php if (!empty($available)) { foreach ($available as $plugin) { ?>
                    <tr>
                        <td style="padding:8px; border-bottom:1px solid #eee;"><?php echo $this->encodeHTML($plugin->plugin_name); ?></td>
                        <td style="padding:8px; border-bottom:1px solid #eee;"><?php echo $this->encodeHTML($plugin->version); ?></td>
                        <td style="padding:8px; border-bottom:1px solid #eee;">
                ...
                <?php } } else { ?>
                    <tr><td colspan="4" style="padding:8px;">No other plugins found.</td></tr>
                <?php } ?>
            </tbody>
        </table>
    </div>
